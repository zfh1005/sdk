...
class RenderingContext extends NativeFieldWrapperClass2 implements CanvasRenderingContext {
  ...
  @DocsEditable()
  List<Shader> getAttachedShaders(Program program) => wrap_jso_list(_blink.BlinkWebGLRenderingContext.instance.getAttachedShaders_Callback_1_(unwrap_jso(this), unwrap_jso(program)));
