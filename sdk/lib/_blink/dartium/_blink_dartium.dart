...
class BlinkIDBKeyRange {
  ...
  bound_Callback_2_(__arg_0, __arg_1) => mthis.callMethod("bound", [__arg_0, __arg_1]);

  bound_Callback_3_(__arg_0, __arg_1, __arg_2) => mthis.callMethod("bound", [__arg_0, __arg_1, __arg_2]);

  bound_Callback_4_(__arg_0, __arg_1, __arg_2, __arg_3) => mthis.callMethod("bound", [__arg_0, __arg_1, __arg_2, __arg_3]);

  lowerBound_Callback_0_() => mthis.callMethod("lowerBound", []);

  lowerBound_Callback_1_(__arg_0) => mthis.callMethod("lowerBound", [__arg_0]);

  lowerBound_Callback_2_(__arg_0, __arg_1) => mthis.callMethod("lowerBound", [__arg_0, __arg_1]);

  lowerOpen_Getter_(mthis) => mthis["lowerOpen"];

  lower_Getter_(mthis) => mthis["lower"];

  only_Callback_0_() => mthis.callMethod("only", []);

  only_Callback_1_(__arg_0) => mthis.callMethod("only", [__arg_0]);

  upperBound_Callback_0_() => mthis.callMethod("upperBound", []);

  upperBound_Callback_1_(__arg_0) => mthis.callMethod("upperBound", [__arg_0]);

  upperBound_Callback_2_(__arg_0, __arg_1) => mthis.callMethod("upperBound", [__arg_0, __arg_1]);
...
class BlinkMediaKeys {
  ...
  create_Callback_0_() => mthis.callMethod("create", []);

  create_Callback_1_(__arg_0) => mthis.callMethod("create", [__arg_0]);

  isTypeSupported_Callback_0_() => mthis.callMethod("isTypeSupported", []);

  isTypeSupported_Callback_1_(__arg_0) => mthis.callMethod("isTypeSupported", [__arg_0]);

  isTypeSupported_Callback_2_(__arg_0, __arg_1) => mthis.callMethod("isTypeSupported", [__arg_0, __arg_1]);
...
class BlinkMediaStreamTrack extends BlinkEventTarget {
  ...
  getSources_Callback_0_() => mthis.callMethod("getSources", []);

  getSources_Callback_1_(__arg_0) => mthis.callMethod("getSources", [__arg_0]);
...
class BlinkNotification extends BlinkEventTarget {
  ...
  requestPermission_Callback_0_() => mthis.callMethod("requestPermission", []);

  requestPermission_Callback_1_(__arg_0) => mthis.callMethod("requestPermission", [__arg_0]);
...
class BlinkURL {
  ...
  createObjectURL_Callback_0_() => mthis.callMethod("createObjectURL", []);

  createObjectURL_Callback_1_(__arg_0) => mthis.callMethod("createObjectURL", [__arg_0]);
  ...
  revokeObjectURL_Callback_0_() => mthis.callMethod("revokeObjectURL", []);

  revokeObjectURL_Callback_1_(__arg_0) => mthis.callMethod("revokeObjectURL", [__arg_0]);
