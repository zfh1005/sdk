...
class BlinkIDBKeyRange {
  ...
  bound_Callback_0_(mthis) => Blink_JsNative_DomException.callMethod(mthis, "bound", []);

  bound_Callback_1_(mthis, __arg_0) => Blink_JsNative_DomException.callMethod(mthis, "bound", [__arg_0]);

  bound_Callback_2_(mthis, __arg_0, __arg_1) => Blink_JsNative_DomException.callMethod(mthis, "bound", [__arg_0, __arg_1]);

  bound_Callback_3_(mthis, __arg_0, __arg_1, __arg_2) => Blink_JsNative_DomException.callMethod(mthis, "bound", [__arg_0, __arg_1, __arg_2]);

  bound_Callback_4_(mthis, __arg_0, __arg_1, __arg_2, __arg_3) => Blink_JsNative_DomException.callMethod(mthis, "bound", [__arg_0, __arg_1, __arg_2, __arg_3]);

  lowerBound_Callback_0_(mthis) => Blink_JsNative_DomException.callMethod(mthis, "lowerBound", []);

  lowerBound_Callback_1_(mthis, __arg_0) => Blink_JsNative_DomException.callMethod(mthis, "lowerBound", [__arg_0]);

  lowerBound_Callback_2_(mthis, __arg_0, __arg_1) => Blink_JsNative_DomException.callMethod(mthis, "lowerBound", [__arg_0, __arg_1]);

  only_Callback_0_(mthis) => Blink_JsNative_DomException.callMethod(mthis, "only", []);

  only_Callback_1_(mthis, __arg_0) => Blink_JsNative_DomException.callMethod(mthis, "only", [__arg_0]);

  upperBound_Callback_0_(mthis) => Blink_JsNative_DomException.callMethod(mthis, "upperBound", []);

  upperBound_Callback_1_(mthis, __arg_0) => Blink_JsNative_DomException.callMethod(mthis, "upperBound", [__arg_0]);

  upperBound_Callback_2_(mthis, __arg_0, __arg_1) => Blink_JsNative_DomException.callMethod(mthis, "upperBound", [__arg_0, __arg_1]);
...
class BlinkMediaSource extends BlinkEventTarget {
  ...
  isTypeSupported_Callback_0_(mthis) => Blink_JsNative_DomException.callMethod(mthis, "isTypeSupported", []);

  isTypeSupported_Callback_1_(mthis, __arg_0) => Blink_JsNative_DomException.callMethod(mthis, "isTypeSupported", [__arg_0]);
...
class BlinkMediaStreamTrack extends BlinkEventTarget {
  ...
  getSources_Callback_0_(mthis) => Blink_JsNative_DomException.callMethod(mthis, "getSources", []);

  getSources_Callback_1_(mthis, __arg_0) => Blink_JsNative_DomException.callMethod(mthis, "getSources", [__arg_0]);
...
class BlinkNotification extends BlinkEventTarget {
  ...
  permission_Getter_(mthis) => Blink_JsNative_DomException.getProperty(mthis, "permission");
  ...
  requestPermission_Callback_0_(mthis) => Blink_JsNative_DomException.callMethod(mthis, "requestPermission", []);

  requestPermission_Callback_1_(mthis, __arg_0) => Blink_JsNative_DomException.callMethod(mthis, "requestPermission", [__arg_0]);
...
class BlinkRTCPeerConnection extends BlinkEventTarget {
  ...
  constructorCallback_0_() => new js.JsObject(Blink_JsNative_DomException.getProperty(js.context, "RTCPeerConnection"), []);

  constructorCallback_1_(__arg_0) => new js.JsObject(Blink_JsNative_DomException.getProperty(js.context, "RTCPeerConnection"), [__arg_0]);

  constructorCallback_2_(__arg_0, __arg_1) => new js.JsObject(Blink_JsNative_DomException.getProperty(js.context, "RTCPeerConnection"), [__arg_0, __arg_1]);
...
class BlinkResponse {
  ...
  redirect_Callback_0_(mthis) => Blink_JsNative_DomException.callMethod(mthis, "redirect", []);

  redirect_Callback_1_(mthis, __arg_0) => Blink_JsNative_DomException.callMethod(mthis, "redirect", [__arg_0]);

  redirect_Callback_2_(mthis, __arg_0, __arg_1) => Blink_JsNative_DomException.callMethod(mthis, "redirect", [__arg_0, __arg_1]);
...
class BlinkURL {
  ...
  createObjectURL_Callback_0_(mthis) => Blink_JsNative_DomException.callMethod(mthis, "createObjectURL", []);

  createObjectURL_Callback_1_(mthis, __arg_0) => Blink_JsNative_DomException.callMethod(mthis, "createObjectURL", [__arg_0]);

  revokeObjectURL_Callback_0_(mthis) => Blink_JsNative_DomException.callMethod(mthis, "revokeObjectURL", []);

  revokeObjectURL_Callback_1_(mthis, __arg_0) => Blink_JsNative_DomException.callMethod(mthis, "revokeObjectURL", [__arg_0]);
